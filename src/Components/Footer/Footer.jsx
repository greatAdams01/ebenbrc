  ...
  return (
    <div>
      <footer className="text-slate-50 bg-opacity-0 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            ...
            <a href="https://www.coingecko.com/en/coins/Edenbrc" target="_blank" rel="noopener noreferrer"><Brandbig imgUrl={coingecko} brand="" /></a>
            <a href="https://coinmarketcap.com/currencies/Edenbrc/" target="_blank" rel="noopener noreferrer"><Brandbig imgUrl={cmc} brand="" /></a>
            ...
            <div className="m-4 ">
                    <ul className="flex items-center space-x-4 ">
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <a href="https://twitter.com/Edenbrc_Arb">
                ...
                <div className="mt-4 sm:mt-0">
                    &copy; {date} Edenbrc All rights reserved.
                </div>
